...
async function main() {
  console.log('Fetching latest workflow run for tag v0.4.2...');
  ...
  console.log('Checking Release Assets for v0.4.2...');
  const relRes = await fetchGitHub('/repos/UG-SIDHARTH/OMNI-PDF/releases/tags/v0.4.2');
